...
1. **Build local Docker image with debos changes**:
   ...
   **Note for environments with MITM proxies:** If you encounter certificate validation errors
     during the build expose the local certificates store to the container build:
