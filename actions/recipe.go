...
- sector: Returns the argument with 's' suffix for raw action`
...
Optionnal properties for recipe:

- sectorsize: Override the default 512 sectorsize, mandatory for device using
4k block size such as UFS or NVMe storage.
...
// We don't know the sector size when processing the template,
